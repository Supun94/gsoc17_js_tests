...
(function( Joomla, document ) {
	 ...
	 * @returns {null}
	 */
	Joomla.submitform = function(task, form, validate) { //done

		console.log("cccccccooo")
		if (!form) {
	 ...
	 * @since 3.7.0
	 */
	Joomla.getOptions = function( key, def ) { //done
		// Load options if they not exists
		console.log('oooooooppppp')
	 ...
	 */
	Joomla.replaceTokens = function( newToken ) {//done
	 ...
	 * @return  {boolean}
	 */
	Joomla.checkAll = function( checkbox, stub ) { //done
	 ...
	 * @return  void
	 */
	Joomla.renderMessages = function( messages, selector, keepOld, timeout ) { //done
	 ...
	 * @return  {void}
	 */
	Joomla.removeMessages = function( container ) { //done
	 ...
	 * @return {void}
	 */
	Joomla.isChecked = function( isitchecked, form ) { //done
	 ...
	 * return  {void}
	 */
	Joomla.tableOrdering = function( order, dir, task, form ) { //done
		if ( typeof form  === 'undefined' ) {
			form = document.getElementById( 'adminForm' );
		}
	 ...
	 */
	window.checkAll_button = function ( n, task ) { //done
